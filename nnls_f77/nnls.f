...
cf2py    DOUBLE PRECISION DIMENSION(N), INTENT(OUT) :: X
cf2py    DOUBLE PRECISION DIMENSION(MDA,N), INTENT(INOUT) :: A
cf2py    INTEGER OPTIONAL,CHECK(SHAPE(A,0)==MDA),DEPEND(A) :: MDA=SHAPE(A,0)
cf2py    INTEGER OPTIONAL, DEPEND(A) :: M=SHAPE(A,0)
cf2py    INTEGER OPTIONAL, DEPEND(A) :: N=SHAPE(A,1)
cf2py    DOUBLE PRECISION DIMENSION(M), INTENT(INOUT) :: B
cf2py    DOUBLE PRECISION, INTENT(OUT) :: RNORM
cf2py    DOUBLE PRECISION DIMENSION(N), INTENT(OUT) :: W
cf2py    DOUBLE PRECISION DIMENSION(M), INTENT(HIDE) :: ZZ
cf2py    INTEGER DIMENSION(N), INTENT(OUT) :: INDEX_BN
cf2py    INTEGER, INTENT(OUT) :: MODE
cf2py    INTEGER, INTENT(OUT) :: NSETP
C     ------------------------------------------------------------------
      MODE=1
