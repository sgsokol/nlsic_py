...
# -*- coding: utf-8 -*-
#
# nlsic documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'nlsic.tex', 'nlsic Documentation',
     'Serguei Sokol', 'manual'),
]
...
man_pages = [
    (master_doc, 'nlsic', 'nlsic Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'nlsic', 'NLSIC Documentation',
     author, 'nlsic', 'Non-linear Least Squares with Inequality Constraints',
     'Scientific software'),
]
